...
<h1>
  ...
  Inicia sesión para continuar con Gmail
  </h2>
</div>
...
<input id="Passwd" name="Passwd" type="password" placeholder="Contraseña" class="">
  </div></div>
  </div>
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Iniciar Sesión">
